...
const ImageIcon = () => {
  return <span >
    <svg style={{ width: '1em', height: '1em' }} className="svg-icon" viewBox="0 0 20 20">
      <path fill="gray" d="M6.523,7.683c0.96,0,1.738-0.778,1.738-1.738c0-0.96-0.778-1.738-1.738-1.738c-0.96,0-1.738,0.778-1.738,1.738
...
const VideoIcon = () => {
  return <span >
    <svg style={{ width: '1em', height: '1em' }} className="svg-icon" viewBox="0 0 20 20">
      <path fill="gray" d="M9.958,5.956c-2.577,0-4.667,2.089-4.667,4.667c0,2.577,2.089,4.667,4.667,4.667s4.667-2.09,4.667-4.667
...
const VideoRender = ({ children }: any) => {
  ...
  return <span style={{ textDecoration: "underline", color: "darkgoldenrod" }}>
    {children}
  </span>
}
